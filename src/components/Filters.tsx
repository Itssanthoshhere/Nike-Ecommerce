...
export default function Filters() {
    ...
    return (
        <>
            ...
            <aside
                className="sticky top-20 hidden h-fit min-w-60 rounded-lg border border-light-300 bg-light-100 p-4 md:block">
            ...
            {open && (
                <div className="fixed inset-0 z-50 md:hidden" role="dialog" aria-modal="true">
                    ...
                    />
                    <div
                        className="absolute inset-y-0 left-0 w-80 max-w-[80%] overflow-auto bg-light-100 p-4 shadow-xl">
                        <div className="mb-2 flex items-center justify-between">
