...
export default async function ProductDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  // Create variant IDs mapping for AddToCartButton
  const variantIdsByColorIndex = galleryVariants.map((gv) => {
    // Find the first variant that matches this color
    const matchingVariant = variants.find((v) => v.color?.name === gv.color);
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-3">
            <AddToCartButton
              ...
              variantIdsByColorIndex={variantIdsByColorIndex}
            />
